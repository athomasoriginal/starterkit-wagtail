...
* .env.example file - cleaned up
* Update README - much easier to start the project and removed old comments
* Update Dockerfiles - added dockerized postgres
* Update Dockerfiles - fixed wagtail Dockerfile
